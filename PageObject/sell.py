...
class Sell:
    ...
    def get_access_to_property(self):
        return self.driver.find_element(By.XPATH,"(//a[@href='https://post.magicbricks.com'])[2]").click()
    ...
    def get_ram(self):
        return self.driver.find_element(By.XPATH, "//*[@id=\"commercialIndex\"]/header/section[2]/div/ul/li[3]/div/div/div[2]/ul/li[3]/a").click()
    ...
    def get_qr(self):
        return self.driver.find_element(By.XPATH,"//*[@id=\"commercialIndex\"]/header/section[2]/div/ul/li[3]/div/div/div[3]/ul/li[2]/a").click()
